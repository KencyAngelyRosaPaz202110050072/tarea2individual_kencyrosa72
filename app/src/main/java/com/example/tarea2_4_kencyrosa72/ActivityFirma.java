...
public class ActivityFirma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingfirma);
    ...
    public void guardarfirma() {
        ...
        try {
            ...
            valores.put(Operaciones.image, Viewfirma(view));
            valores.put(Operaciones.descripcion, descripcionText);

            Long resultado = db.insert(Operaciones.tabla_firmas, Operaciones.id, valores);
